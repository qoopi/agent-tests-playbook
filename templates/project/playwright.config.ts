...
// a password. The names of the account variables live in .env.example.
// init-project: login
const LOGIN = false;
export const AUTH_FILE = '.playwright/auth/user.json';
if (LOGIN && !(process.env.TEST_USER_EMAIL && process.env.TEST_USER_PASSWORD)) {
  throw new Error('TEST_USER_EMAIL and TEST_USER_PASSWORD are missing in .env');
}
